...
// Hopping channel map for a device which uses all three systems: M-Band, O-Band LDR and HDR
// Function HopChannel() generates channel number 0..3 and this translates to the system/frequency:
// 0 => M-band 868.2MHz, 1 => M-Band 868.4MHz, 2 => O-Band LDR, 3 => O-Band HDR
