// Attempt to produce an altitude-dependend sequence to hop across 3 channels.
...
{ const int Acfts   = 60;                             // 60 aircrafts from 0 to 6000m
  const int RefAcft = 15;                             // reference aircraft at 1000m
  ...
  { int SlotOccup[4] = { 0, 0, 0, 0 };
    ...
    printf(" %d [%2d:%2d:%2d:%2d]\n", Chan[RefAcft], SlotOccup[0], SlotOccup[1], SlotOccup[2], SlotOccup[3]); }

  printf("Occup[4] = %d %d %d %d\n", Occup[0], Occup[1], Occup[2], Occup[3]);
