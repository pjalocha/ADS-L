...
const uint32_t IntSine_Scale=0x40000000;
...
// int16_t inline Isin(int32_t Angle) { return Isin((int16_t)((Angle+0x00008000)>>16)); }
// int16_t inline Icos(int32_t Angle) { return Isin((int16_t)((Angle+0x40008000)>>16));; }
...
inline uint32_t IntDistance(int32_t dX, int32_t dY, int32_t dZ)
{ return IntSqrt((uint64_t)((int64_t)dX*dX + (int64_t)dY*dY + (int64_t)dZ*dZ)); }
